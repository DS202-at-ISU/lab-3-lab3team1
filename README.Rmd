...
deaths <- av %>% rowwise() %>% mutate(Time = sum(c(Death1, Death2, Death3, Death4, Death5) == "YES"))
...
```{r}
returns <- av %>% rowwise() %>% mutate(Time = sum(c(Return1, Return2, Return3, Return4, Return5) == "YES"))
```
